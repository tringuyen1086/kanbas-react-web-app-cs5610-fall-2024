...
export default function PeopleTable() {
    ...
    // Get all users enrolled in the current course (using course ID)
    const enrolledUsers = enrollments
        .filter((enrollment) => enrollment.course === cid) // Filter enrollments by course ID
        .map((enrollment) => enrollment.user); // Extract user IDs from the enrollments

    // Filter users based on enrollment
    const filteredUsers = users.filter((user) => enrolledUsers.includes(user._id));
    ...
    return (
        <div id="wd-people-table">
            <table className="table table-striped">
                ...
                <td className="wd-total-activity">10:31:42</td> </tr>                
                ...
                <td className="wd-total-activity">11:41:42</td> </tr>
