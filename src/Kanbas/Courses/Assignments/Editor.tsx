...
import { setAssignment, updateAssignment, addAssignment, Assignment } from "./reducer";
...
export default function AssignmentEditor() {
    ...
    const currentAssignment = useSelector((state: RootState) =>
        state.assignments.assignments.find((a: Assignment) => a._id === assignmentId)
    );

    const [assignment, setAssignmentState] = useState<Assignment>({
        _id: assignmentId || Date.now().toString(),
        title: "",
        description: "",
        points: 100,
        dueDate: "",
    ...
    useEffect(() => {
        if (currentAssignment && assignmentId) {
            setAssignmentState(currentAssignment);
        }
        ...
        <div id="wd-assignments-editor" className="container mt-4">
            <div className="mb-3">
                ...
                <input
                    ...
                    onChange={(e) => setAssignmentState({ ...assignment, title: e.target.value })}
                />
            </div>
            <div className="mb-3">
                ...
                <textarea
                    ...
                    onChange={(e) => setAssignmentState({ ...assignment, description: e.target.value })}
                />
            </div>
            <div className="mb-3">
                ...
                <input
                    ...
                    onChange={(e) => setAssignmentState({ ...assignment, points: Number(e.target.value) })}
                />
            </div>
            <div className="mb-3">
                ...
                <Datetime
                    ...
                    onChange={(date) => setAssignmentState({ ...assignment, dueDate: date.toString() })}
            ...
            <div className="mb-3">
                ...
                <Datetime
                    ...
                    onChange={(date) => setAssignmentState({ ...assignment, availableFrom: date.toString() })}
                    dateFormat="MMM DD, YYYY"
                    timeFormat="hh:mm A"
                />
            </div>
            <div className="mb-3">
                ...
                <Datetime
                    ...
                    onChange={(date) => setAssignmentState({ ...assignment, availableUntil: date.toString() })}
                    dateFormat="MMM DD, YYYY"
                    timeFormat="hh:mm A"
                />
            </div>
